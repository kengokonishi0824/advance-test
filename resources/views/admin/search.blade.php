  ...
  <form action="/search" method="get" class="">
    <div class="search_name_gender">
      <p class="search_title">お名前<p>
        <input type="text" name="fullname" class="contact_search" value="@if (isset($fullname)) {{ $fullname }} @endif">
    ...
    <div class="search_email">
      <p class="search_title">メールアドレス<p>
        <input type="calender" name="email" class="contact_search" value="@if (isset($email)) {{ $email}} @endif">
    </div>
...
<div class = "pagination">
  ...
  <div>{{$contacts->appends(request()->query())->links('pagination::default')}}</div>
</div>
